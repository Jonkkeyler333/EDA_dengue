...
```
Se muestran los resumenes estadisticos de las nuevas caracteristicas generadas para verificar que el proceso se hubiese realizado de una manera exitosa
```{r}

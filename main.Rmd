...
```{r}
p7<-df_n %>%count(grupos,estrato_,name = "total")
p7 <- df_n %>%
...
treemap(p7,index=c("grupos","estrato_"),vSize="total",vColor="total_grupo",type = "value",palette="RdYlBu",title="Distribución de estrato socioeconómico por grupo",fontsize.title=14)
